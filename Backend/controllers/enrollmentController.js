...
const enrollInCourse = async (req, res) => {
    try {
        ...
        await UserModel.findByIdAndUpdate(userId, { $push: { enrolledCourses: enrollment._id } });
        await CourseModel.findByIdAndUpdate(courseId, { $push: { enrollments: enrollment._id } });
...
const deleteEnrollment = async (req, res) => {
    try {
        ...
        await UserModel.findByIdAndUpdate(enrollment.userId, { $pull: { enrolledCourses: enrollment._id } });
        await CourseModel.findByIdAndUpdate(enrollment.courseId, { $pull: { enrollments: enrollment._id } });
