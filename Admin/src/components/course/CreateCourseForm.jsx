...
const CreateCourseForm = () => {
  const { token } = useAuth();
  const { fetchCourses } = useContext(TestContext); // Access fetchCourses from TestContext
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      await fetchCourses(); // Refresh courses after saving draft
      setFormData({
        title: '',
        description: '',
        examType: '',
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      await fetchCourses(); // Refresh courses after publishing
      setFormData({
        title: '',
        description: '',
        examType: '',
...
//     try {
//       const response = await axios.post('http://localhost:5000/api/course', form, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           'Content-Type': 'multipart/form-data',
//         },
