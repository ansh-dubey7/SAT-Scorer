...
// const HandholdingCard = () => {
//   return (
//     <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg shadow-md p-6">
//       <h2 className="text-xl font-semibold mb-2">Free Handholding Session</h2>
//       <p className="text-sm mb-4">Book a free session with our expert mentors to kickstart your exam prep!</p>
//       <Link
//         to="/contactus"
//         className="inline-block px-4 py-2 bg-white text-blue-600 rounded-lg hover:bg-gray-100"
//       >
//         Book Now
//       </Link>
//     </div>
