...
// const ExamSidebar = () => {
//   const exams = ['sat', 'gre', 'gmat', 'ielts', 'ap', 'acp'];
//   const location = useLocation();

//   return (
//     <aside className="w-64 bg-gray-100 h-screen fixed top-16 left-0 z-40 font-sans">
//       <nav className="p-4">
...
//               <Link
//                 to={`/exams/${exam}`}
//                 className={`block px-4 py-2 rounded-lg uppercase ${
