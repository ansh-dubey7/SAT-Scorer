...
// const ExamPage = () => {
//   const { examType } = useParams();
//   const { user, fetchProtected } = useContext(AuthContext); // Access user and fetchProtected
//   const [courses, setCourses] = useState([]);
...
//           setCourses(filteredCourses);
//         } else {
//           throw new Error(coursesResponse.data.message || 'Failed to fetch courses');
//         }
...
//                     (enrollment) => enrollment.courseId.toString() === course._id && enrollment.status === 'active'
//                   )}
//                 />
//               </div>
//             ))}
