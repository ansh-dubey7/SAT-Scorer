        ...
        <div className="max-w-7xl mx-auto px-4 py-12 flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3">
            ...
            <div ref={overviewRef}>
              ...
              <p className="text-gray-600">
                Students preparing for the {course.examType.toUpperCase()} exam
              </p>
            </div>
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-20 bg-white rounded-lg shadow-md p-6">
              ...
              <button
                onClick={handleBuyNow}
                className="w-full px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 mb-4"
              >
                Enroll Now
              </button>
